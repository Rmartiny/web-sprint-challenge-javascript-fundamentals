...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:  the nested function can reach out of its scope to pull infromation to fufil its prupose.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const amerPop=  array.reduce((acc,item) => acc +item.population,0)
    return amerPop 
  }
